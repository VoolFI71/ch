// SVG компоненты для шахматных фигур
// Используются вместо Unicode символов для более профессионального вида

const BLACK_PIECE_FILL = '#020202';
const BLACK_PIECE_ACCENT = '#0b0b0b';
const BLACK_PIECE_STROKE = '#f8fafc';

const ChessPiecesSVG = {
  // Белые фигуры
  ...
  // Чёрные фигуры
  k: `<svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="${BLACK_PIECE_FILL}" stroke="${BLACK_PIECE_STROKE}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M 22.5,11.63 L 22.5,6" stroke-linejoin="miter"/>
      <path d="M 20,8 L 25,8" stroke-linejoin="miter"/>
      <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" fill="${BLACK_PIECE_ACCENT}" stroke-linecap="butt" stroke-linejoin="miter"/>
      <path d="M 12.5,37 C 18,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 12.5,37 z" fill="${BLACK_PIECE_FILL}"/>
      <path d="M 12.5,30 C 18,27 27,27 32.5,30" fill="none"/>
      <path d="M 12.5,33.5 C 18,30.5 27,30.5 32.5,33.5" fill="none"/>
      <path d="M 12.5,37 C 18,34 27,34 32.5,37" fill="none"/>
    </g>
  ...
  q: `<svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="${BLACK_PIECE_FILL}" stroke="${BLACK_PIECE_STROKE}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M 11.5,30 C 15,29 30,29 33.5,30" fill="none"/>
      <path d="M 12,33.5 C 18,32.5 27,32.5 33,33.5" fill="none"/>
      <g fill="${BLACK_PIECE_ACCENT}" stroke="none">
        <circle cx="6" cy="12" r="2"/>
        <circle cx="14" cy="9" r="2"/>
        <circle cx="22.5" cy="8" r="2"/>
        <circle cx="31" cy="9" r="2"/>
  ...
  b: `<svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="${BLACK_PIECE_FILL}" stroke="${BLACK_PIECE_STROKE}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 32.61,35.03 36,36 C 36,36 37.65,36.54 39,38 C 38.32,38.97 37.35,38.99 36,38.5 C 32.61,37.53 25.89,38.96 22.5,37.5 C 19.11,38.96 12.39,37.53 9,38.5 C 7.65,38.99 6.68,38.97 6,38 C 7.35,36.54 9,36 9,36 z"/>
      <path d="M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30 C 30,27.5 27.5,26 27.5,26 C 33,24.5 33.5,14.5 22.5,10.5 C 11.5,14.5 12,24.5 17.5,26 C 17.5,26 15,27.5 15,30 C 15,30 14.5,30.5 15,32 z"/>
      <path d="M 25 8 A 2.5 2.5 0 1 1 20,8 A 2.5 2.5 0 1 1 25 8 z" fill="${BLACK_PIECE_ACCENT}"/>
      <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18" fill="none" stroke-linejoin="miter"/>
    </g>
  </svg>`,
  ...
  n: `<svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="${BLACK_PIECE_FILL}" stroke="${BLACK_PIECE_STROKE}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" fill="${BLACK_PIECE_FILL}"/>
      <path d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10" fill="${BLACK_PIECE_ACCENT}"/>
...
// Функция для получения SVG фигуры
function getPieceSVG(piece) {
  return ChessPiecesSVG[piece] || '';
}
